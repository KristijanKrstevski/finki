...
////
////                        // Accessible only by HOSTs
////                        .requestMatchers(
////                                "/api/accommodations/add", "/api/accommodations/edit/**", "/api/accommodations/reserve/**",
////                                "/api/hosts/add", "/api/hosts/edit/**", "/api/hosts/delete/**",
////                                "/api/countries/add", "/api/countries/edit/**", "/api/countries/delete/**"
////                        ).hasRole("HOST")
////
////                        // All other requests must be authenticated (e.g. ROLE_USER can access GETs)
